...
Route::get('/setting/carouselGetImages',  [CarouselImagesController::class, 'getImages']);
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::middleware('checkAdmin')->controller(MergeController::class)->group(function () {
        Route::get('/setting/allMerge', 'GetAllMerge');
        Route::get('/setting/merge/{id}', 'getMerge');
        Route::post('/setting/addMerge', 'addMerge');
        Route::post('/setting/editMerge/{id}', 'editMerge');
        Route::post('/setting/deleteMerge/{id}', 'destroy');
    });
    Route::middleware('checkAdmin')->controller(CarouselImagesController::class)->group(function () {
        Route::post('/setting/carouselAddImage', 'setImage');
        Route::delete('/setting/carouselDeleteImage/{id}', 'deleteImage');
        Route::post('/setting/carouselEditDescription', 'setEditDescription');
    });
    ...
    Route::post('/addToCart', [CartItemsController::class, 'add']);
    Route::delete('/deleteFromCart/{id}', [CartItemsController::class, 'delete']);
    Route::get('/currentUserCart/{id}', [CartItemsController::class, 'getUserCart']);
    Route::post('/showShoppingCart', [CartItemsController::class, 'showAll']);
